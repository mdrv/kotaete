...
const SCHEMA_QUERIES = [
	...
	`DEFINE FIELD OVERWRITE kananame ON season_score TYPE option<string>`,
	`DEFINE FIELD OVERWRITE nickname ON season_score TYPE option<string>`,
	`DEFINE FIELD OVERWRITE classgroup ON season_score TYPE option<string>`,
