...
const SCHEMA_QUERIES = [
	...
	`DEFINE FIELD IF NOT EXISTS season_id ON season TYPE string`,
	`DEFINE FIELD IF NOT EXISTS group_id ON season TYPE string`,
	`DEFINE FIELD IF NOT EXISTS caption ON season TYPE option<string>`,
	`DEFINE FIELD IF NOT EXISTS status ON season TYPE string DEFAULT 'active'`,
	`DEFINE FIELD IF NOT EXISTS created_at ON season TYPE datetime DEFAULT time::now()`,
	`DEFINE FIELD IF NOT EXISTS updated_at ON season TYPE datetime DEFAULT time::now()`,
	`DEFINE INDEX IF NOT EXISTS season_id_unique ON season COLUMNS season_id UNIQUE`,
	`DEFINE TABLE IF NOT EXISTS season_score SCHEMAFULL`,
	`DEFINE FIELD IF NOT EXISTS season_id ON season_score TYPE string`,
	`DEFINE FIELD IF NOT EXISTS mid ON season_score TYPE string`,
	`DEFINE FIELD IF NOT EXISTS points ON season_score TYPE number DEFAULT 0`,
	`DEFINE FIELD IF NOT EXISTS reached_at ON season_score TYPE option<number>`,
